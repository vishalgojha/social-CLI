...
class AutonomousAgent {
  ...
  async heuristicDecision(userInput) {
    ...
    if (shouldAskClarification(userInput, intent)) {
      return {
        message: 'I am not fully sure what you want yet. Tell me the exact goal, like: "show my pages", "check auth status", or "post this to Facebook".',
        actions: [],
        needsInput: true,
        suggestions: [
          'Examples: "show my Facebook pages", "debug token ...", "check webhook subscriptions".',
