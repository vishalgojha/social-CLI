...
function runMorningOps({
  ...
  storage.appendActionLog(ws, {
    ...
    risk: 'medium',
    actor: user,
    why: 'Scheduled morning workspace health run',
...
function resolveApproval({
  ...
  storage.appendActionLog(ws, {
    ...
    actor: user,
    why: note || `Approval ${resolved.status}`,
...
function runDueSchedules({
  ...
  storage.appendActionLog(ws, {
    ...
    risk: 'medium',
    actor: user,
    why: 'Process due scheduled workflows',
